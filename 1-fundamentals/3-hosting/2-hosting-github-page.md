...
<!---->
    ...
    .container {max-width: 800px;margin: 0 auto;padding: 20px;background-color: #ffffff;box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);
    }
...
<!---->
    ...
    paragraph.addEventListener('click', function() {// Change the text content of the paragraph
